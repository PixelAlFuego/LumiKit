...
|---|---|---|---|---|
| `Prefabs/UI/PRF_ParameterPanel.prefab` | `ParameterPanelBuilder` | ParameterPanelUI + Surface (Image) + Header + Content (VerticalLayoutGroup, ContentSizeFitter) + Footer (separador, HorizontalLayoutGroup, `LumiButton` Reset) | LK-11a · LK-22a · LK-51 · LK-50 | ✅ |
