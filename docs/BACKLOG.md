...
| 3 | LK-11a, LK-11b, LK-49, LK-22 | ParameterWidgetBase + Slider/Color/Toggle/Enum, ParameterPanelUI, LumiTheme.cs con la paleta, prefabs de UI generados por script. El pie del panel (Reset) cae en LK-22 |
